...
import 'package:water_tracker/pages/view/addmedicine/add_medicine.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(children: [
          ...
          Expanded(
            child: Consumer<MedcineProivder>(
                builder: (context, MedcineProivder, _) {
              final box = MedcineProivder.meddatas;
                            ...
                            child: SizedBox(
                              ...
                              child: Stack(children: [
                                ...
                                Align(
                                    ...
                                    child: Text("Dose : ${data[index].pill}")),
                                Align(
                                        ...
                                        QuickAlert.show(
                                            ...
                                            onConfirmBtnTap: () {
                                              ...
                                              setState(() {
                                                ...
                                                MedicineCopyModel medComplete =
                                                    MedicineCopyModel(
                                                        date: data[index].note,
                                                        dose: data[index].dose,
                                                        pill: data[index].pill);
