...
import 'homepage/home_pageui.dart';
...
class _MyHomeState extends State<MyHome> {
  ...
  Future<void> deleteAllData() async {
    ...
    Navigator.pushAndRemoveUntil(context,
        MaterialPageRoute(builder: (build) => SplashReset()), (route) => false);
  }
  ...
  final _pages = [const MyHomePage(), const MyHistory1(), WaterProgressChart()];
  @override
                ...
                children: [
                  ...
                  Card(
                    ...
                    child: ListTile(
                      ...
                      onTap: () async {
                        await Share.share(
                          'https://play.google.com/store/apps/details?id=com.akshaykp.iHydrate',
